...
class ProductAttributesControllerTest < ActionController::TestCase
  ...
  test "should create product_attribute" do
    assert_difference('ProductAttribute.count') do
      post :create, product_attribute: { desc: @product_attribute.desc, key: @product_attribute.key, permalink: @product_attribute.permalink, product_id: @product_attribute.product_id, value: @product_attribute.value }
    end
  ...
  test "should update product_attribute" do
    patch :update, id: @product_attribute, product_attribute: { desc: @product_attribute.desc, key: @product_attribute.key, permalink: @product_attribute.permalink, product_id: @product_attribute.product_id, value: @product_attribute.value }
    assert_redirected_to product_attribute_path(assigns(:product_attribute))
  end
